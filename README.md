...
## Papers
* 2023-ViDAR: Visual Point Cloud Forecasting enables Scalable Autonomous Driving  __`arxiv`__; __`Pre-training`__;  __`NuScenes dataset`__ [Paper](https://arxiv.org/abs/2312.17655)
...
* 2020-DreamerV2: Mastering Atari with Discrete World Models __`ICLR 2021`__; __`RL`__ [Paper](https://arxiv.org/pdf/2010.02193.pdf) [Code](https://github.com/danijar/dreamerv2)
* 2018-DreamerV1: Model-Based Planning with Discrete and Continuous Actions __`arxiv`__; __`from Yann Lecun's Group`__; __`RL`__ [Paper](https://arxiv.org/abs/1705.07177)
